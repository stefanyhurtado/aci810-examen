...
public class TitleActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String Escriba_Titulo = sharedPref.getString(ApplicationActivity.ESCRIBA_TITULO, "not set");
		
		
		 TextView EscribtTextView = (TextView) findViewById(R.id.TextView);
	        EscribtTextView.setText(Escriba_Titulo);
